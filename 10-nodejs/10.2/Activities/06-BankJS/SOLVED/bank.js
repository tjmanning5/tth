...
switch (action) {
    case "total":
        console.log('Getting total from your bank account');
        total();
        break;
...
function deposit() {
    ...
    fs.appendFile("bank.txt", delimiter + value);
...
function lotto() {
    ...
    if (chance === 1) {
        ...
        fs.appendFile("bank.txt", delimiter + "2");
