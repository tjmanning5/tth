...
var Main = React.createClass({
  ...
  getInitialState: function() {
    return {
      ...
      artistry: 94,
      isFuzzy: true,
      img: "http://nick.mtvnimages.com/nick/promos-thumbs/videos/spongebob-squarepants/rainbow-meme-video/spongebob-rainbow-meme-video-16x9.jpg?quality=0.60"
    };
  },
    ...
    return (
      <div className="container">
        <div className="row">
          ...
          <Child
            myDaddysAge={this.state.age}
            myDadIsHairy={! this.state.isFuzzy}
            myDadsArtsyFartsyScore={this.state.artistry}
          />
        </div>
      </div>
    );
