...
mongoose.connect("mongodb://localhost/mongooseusersdb");
...
// The "unique" rule in the Library 
// model's schema will prevent duplicate libraries from being added to the server
